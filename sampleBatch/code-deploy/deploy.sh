ORIGIN_JAR_PATH='/home/jenkins/ec2-sample-batch/deploy/*.jar'
ORIGIN_JAR_NAME=$(basename ${ORIGIN_JAR_PATH})
TARGET_PATH='/home/jenkins/ec2-sample-batch/application.jar'
JAR_BOX_PATH='/home/jenkins/ec2-sample-batch/jar/'
